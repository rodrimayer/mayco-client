...
/***/ "../../../../../src/app/_service/rest-client.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RestClientService; });
...
var RestClientService = /** @class */ (function () {
    function RestClientService(_http) {
        this._http = _http;
        this.INSERT = 1;
        this.DELETE = 2;
    }
    RestClientService.prototype.list = function (url_base, url_resource) {
        return this._http.get(url_base + url_resource);
    };
    RestClientService.prototype.insert = function (aObject, url_base, url_resource) {
        return this.insertOrDelete(aObject, url_base, url_resource, this.INSERT);
    };
    RestClientService.prototype.delete = function (aObject, url_base, url_resource) {
        return this.insertOrDelete(aObject, url_base, url_resource, this.DELETE);
    };
    RestClientService.prototype.insertOrDelete = function (aObject, url_base, url_resource, operation) {
        var url = url_base + url_resource;
        var body = JSON.stringify(aObject);
        var headers0 = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'Content-Type': 'application/json' });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: headers0 });
        switch (operation) {
            case this.INSERT:
                console.log('INSERT');
...
/***/ "../../../../../src/app/projects/_service/project.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__service_rest_client_service__ = __webpack_require__("../../../../../src/app/_service/rest-client.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__environments_rest_environment__ = __webpack_require__("../../../../../src/environments/rest-environment.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProjectService = /** @class */ (function () {
    function ProjectService(_restClientService) {
        this._restClientService = _restClientService;
    }
    ProjectService.prototype.list = function () {
        var obs = this._restClientService.list(__WEBPACK_IMPORTED_MODULE_4__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_4__environments_rest_environment__["e" /* URL_PROJECT_LIST */]);
        obs.subscribe(function (rs) { return console.log(rs); });
        return obs.map(function (res) { return res.json(); })
            .do(function (data) { return console.log('data' + JSON.stringify(data)); });
    };
    ProjectService.prototype.insert = function (project) {
        return this._restClientService.insert(project, __WEBPACK_IMPORTED_MODULE_4__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_4__environments_rest_environment__["c" /* URL_PROJECT_ADD */]);
    };
    ProjectService.prototype.delete = function (project) {
        return this._restClientService.delete(project, __WEBPACK_IMPORTED_MODULE_4__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_4__environments_rest_environment__["d" /* URL_PROJECT_DELETE */]);
    };
    ProjectService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__service_rest_client_service__["a" /* RestClientService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__service_rest_client_service__["a" /* RestClientService */]) === "function" && _a || Object])
    ], ProjectService);
...
/***/ "../../../../../src/app/skills/_service/skill.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__environments_rest_environment__ = __webpack_require__("../../../../../src/environments/rest-environment.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SkillService = /** @class */ (function () {
    function SkillService(_restClientService) {
        this._restClientService = _restClientService;
    }
    SkillService.prototype.list = function () {
        var obs = this._restClientService.list(__WEBPACK_IMPORTED_MODULE_3__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_3__environments_rest_environment__["h" /* URL_SKILL_LIST */]);
        obs.subscribe(function (rs) { return console.log(rs); });
        return obs.map(function (res) { return res.json(); });
    };
    SkillService.prototype.insert = function (skill) {
        return this._restClientService.insert(skill, __WEBPACK_IMPORTED_MODULE_3__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_3__environments_rest_environment__["f" /* URL_SKILL_ADD */]);
    };
    SkillService.prototype.delete = function (skill) {
        return this._restClientService.delete(skill, __WEBPACK_IMPORTED_MODULE_3__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_3__environments_rest_environment__["g" /* URL_SKILL_DELETE */]);
    };
...
/***/ "../../../../../src/app/users/_service/users.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UsersService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_typescript_map__ = __webpack_require__("../../../../typescript-map/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_typescript_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_typescript_map__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__ = __webpack_require__("../../../../../src/environments/rest-environment.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UsersService = /** @class */ (function () {
    function UsersService(_restClientService) {
        this._restClientService = _restClientService;
    }
    UsersService.prototype.list = function () {
        var obs = this._restClientService.list(__WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__["k" /* URL_USER_LIST */]);
        obs.subscribe(function (rs) { return console.log(rs); });
        return obs.map(function (res) { return res.json(); })
            .do(function (data) { return console.log('data' + JSON.stringify(data)); });
    };
    UsersService.prototype.insert = function (user) {
        return this._restClientService.insert(user, __WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__["i" /* URL_USER_ADD */]).map(function (res) { return new __WEBPACK_IMPORTED_MODULE_1_typescript_map__["TSMap"]().fromJSON(res.json()); });
    };
    UsersService.prototype.delete = function (user) {
        return this._restClientService.delete(user, __WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__["j" /* URL_USER_DELETE */]);
    };
    UsersService.prototype.login = function (user) {
        return this._restClientService.insert(user, __WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__["a" /* URL_BASE */], __WEBPACK_IMPORTED_MODULE_5__environments_rest_environment__["l" /* URL_USER_LOGIN */]).map(function (res) { return new __WEBPACK_IMPORTED_MODULE_1_typescript_map__["TSMap"]().fromJSON(res.json()); });
    };
    UsersService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__service_rest_client_service__["a" /* RestClientService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__service_rest_client_service__["a" /* RestClientService */]) === "function" && _a || Object])
    ], UsersService);
    return UsersService;
    var _a;
}());
...
/***/ "../../../../../src/environments/rest-environment.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* unused harmony export SERVER */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return URL_BASE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return URL_PROJECT_LIST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return URL_PROJECT_ADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return URL_PROJECT_DELETE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return URL_SKILL_LIST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return URL_SKILL_ADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return URL_SKILL_DELETE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return URL_USER_LIST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return URL_USER_ADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return URL_USER_DELETE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return URL_USER_LOGIN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return URL_MAIL_SEND; });
var SERVER = {
...
var URL_BASE = SERVER.ADDRESS + SERVER.PORT;
var URL_PROJECT_LIST = '/project/list';
var URL_PROJECT_ADD = '/project/add';
var URL_PROJECT_DELETE = '/project/delete';
var URL_SKILL_LIST = '/skill/list';
var URL_SKILL_ADD = '/skill/add';
var URL_SKILL_DELETE = '/skill/delete';
var URL_USER_LIST = '/user/list';
var URL_USER_ADD = '/user/add';
var URL_USER_DELETE = '/user/delete';
var URL_USER_LOGIN = '/user/login';
var URL_MAIL_SEND = '/mail/send';
//# sourceMappingURL=rest-environment.js.map
 ...
 * \@stable
 */
var VERSION = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["_16" /* Version */]('4.4.3');
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
